...
module Vault
  describe Defaults do
    ...
    describe ".k8s_auth_url_prefix" do
      it "defaults to ENV['VAULT_K8S_AUTH_URL_PREFIX']" do
        with_stubbed_env("VAULT_K8S_AUTH_URL_PREFIX" => "new-cluster") do
          expect(Defaults.k8s_auth_url_prefix).to eq("new-cluster")
        end
      end
    end
  end
